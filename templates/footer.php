...
<div class="row py-3">
	<div class="col-md text-center">
		...
		<p class="lead">
			...
			<i class="fa fa-chevron-left" aria-hidden="true"></i><i class="fa fa-chevron-right" aria-hidden="true"></i> with <i class="fa fa-heart" aria-hidden="true"></i> using <a href="http://getbootstrap.com/" target="_blank"><img src="/img/bootstrap.png" alt="Bootstrap" style="max-width: 30px; max-height: 30px"></a>.<br>
